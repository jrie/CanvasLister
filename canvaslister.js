...
function canvasLister(canvasItemId, sourceFile, fontDefaultFamily, fontDefaultSize, fontDefaultWeight, fontDefaultShape, defaultLineSpacingPercentage, textAlignment, backgroundColor, fontDefaultColor, sourceText) {
                ...
                if (useFormat) {
                    ...
                    if (orderLevel >= orderSize) {
                        ...
                        if (wordIndex >= dataPoints[0]) {
                            ...
                            if ((triggers[orderLevel] === false || triggerWord === triggers[orderLevel][0][1]) && wordIndex >= dataPoints[orderLevel]) {
